...
function drawRecursiveEdge(resLayer, pos, white, vertical, TL) {
  ...
  drawEntireThing(resLayer + 2, entireThingPos, white);
  drawRecursiveEdge(resLayer + 1, edgePos(pos, pos_constants, 1), white, vertical);
  drawRecursiveEdge(resLayer + 2, edgePos(pos, pos_constants, 2), white, vertical);
  drawRecursiveEdge(resLayer + 3, edgePos(pos, pos_constants, 3), white, vertical);
};
